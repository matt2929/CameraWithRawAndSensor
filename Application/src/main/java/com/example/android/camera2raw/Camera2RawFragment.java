...
public class Camera2RawFragment extends Fragment
    ...
    public void setSensorText(String[] names, String[] val) {
        String str = "";
    ...
    private final CameraCaptureSession.CaptureCallback mCaptureCallback
        ...
        public void onCaptureStarted(CameraCaptureSession session, CaptureRequest request,
            ...
            File parentDirectory1 = new File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS)+ File.separator+"LightData"+File.separator+CameraActivity.dateStampFile+File.separator);
            if (!parentDirectory1.exists()) {
                parentDirectory1.mkdir();
            } File rawFile = new File(parentDirectory1,
                    "RAW_" + currentDateTime + ".dng");
            File jpegFile = new File(parentDirectory1,
        ...
        public void onCaptureCompleted(CameraCaptureSession session, CaptureRequest request,
            ...
            synchronized (mCameraStateLock) {
                ...
                // If wehave all the results necessary, save the image to a file in the background.
    ...
    public void onViewCreated(final View view, Bundle savedInstanceState) {
        ...
        view.findViewById(R.id.swapButton).setOnClickListener(this);
                    ...
                    if (mJpegImageReader == null || mJpegImageReader.getAndRetain() == null) {
                        mJpegImageReader = new RefCountedAutoCloseable<>(
                                ImageReader.newInstance(largestJpeg.getWidth(),
                                        largestJpeg.getHeight(), ImageFormat.JPEG, /*maxImages*/7));
                    }
                    ...
                    if (mRawImageReader == null || mRawImageReader.getAndRetain() == null) {
                        mRawImageReader = new RefCountedAutoCloseable<>(
                                ImageReader.newInstance(largestRaw.getWidth(),
                                        largestRaw.getHeight(), ImageFormat.RAW_SENSOR, /*maxImages*/ 7));
                    }
